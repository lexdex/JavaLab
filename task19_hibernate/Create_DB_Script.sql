...
-- -----------------------------------------------------
-- Schema hibernate_library_db
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema hibernate_library_db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `hibernate_library_db` DEFAULT CHARACTER SET utf8 ;
USE `hibernate_library_db` ;

-- -----------------------------------------------------
-- Table `hibernate_library_db`.`city`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hibernate_library_db`.`city` (
...
-- -----------------------------------------------------
-- Table `hibernate_library_db`.`library`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hibernate_library_db`.`library` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `books` INT NOT NULL,
  ...
  CONSTRAINT `fk_library_city1`
    FOREIGN KEY (`city_id`)
    REFERENCES `hibernate_library_db`.`city` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hibernate_library_db`.`book`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hibernate_library_db`.`book` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `hibernate_library_db`.`library_has_book`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hibernate_library_db`.`library_has_book` (
  ...
  CONSTRAINT `fk_library_has_book_library`
    ...
    REFERENCES `hibernate_library_db`.`library` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_library_has_book_book1`
    FOREIGN KEY (`book_id`)
    REFERENCES `hibernate_library_db`.`book` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
