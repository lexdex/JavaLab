...
public class BXDroidCommando extends Droid {
    private static final double ATTACK_SPEED = 5.0; // interval [0, 5]
    private static final double DARK_POWER = 5.0;  // special droid characteristic interval [0, 5]
    private static final int MINIMAL_DAMAGE = 5;
    private static final int MAXIMAL_DAMAGE = 10;
    ...
    public BXDroidCommando(int health, int attack, int armorValue, boolean alive, boolean armor) {
    ...
    public String printDroidInfo() {
        String info = "\tType: BXDroidCommando\n" +
                "\tHealth: " + getHealth() + " HP" + "\n" +
                "\tArmor: " + getArmorValue() + "\n" +
                "\tAttack: " + getAttack() + "\n" +
